...
import { ENTRANCE, VIEWPORT, VIEWPORT_WIDE, fadeUp, stagger } from "./motion";
...
/** Horizontal meter used by the volume, zone and accuracy charts. */
      ...
      <div className="mx-auto w-full max-w-[1290px]">
        ...
        >
          ...
          <div className="space-y-3 p-4 sm:p-5">
            ...
            {/* ── Zone compliance + model accuracy ─────────────────── */}
