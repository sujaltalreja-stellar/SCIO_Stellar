  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "welcome",
      sender: "copilot",
      text: "SCIO Operations Copilot online. How can I assist you with operational diagnostics, asset risks, or maintenance summaries today?",
      timestamp: new Date()
    }
  ]);
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (apiKey) {
        ...
        const contextText = `You are SCIO Operations Copilot. Answer user queries based on this real-time data:
